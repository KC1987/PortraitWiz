...
const categoryGradients: Record<string, string> = {
  Formal: "from-slate-200/70 via-slate-100 to-slate-300/70",
  "Business Casual": "from-amber-200/70 via-orange-100 to-yellow-200/70",
  Professional: "from-sky-200/70 via-sky-100 to-blue-200/70",
  Creative: "from-fuchsia-200/70 via-purple-100 to-indigo-200/70",
  Seasonal: "from-emerald-200/70 via-teal-100 to-sky-200/70",
}
