...
const categoryGradients: Record<string, string> = {
  Studio: "from-sky-200/70 via-sky-100 to-blue-200/70",
  Office: "from-slate-200/70 via-slate-100 to-slate-300/70",
  Hospitality: "from-amber-200/70 via-orange-100 to-orange-200/70",
  Outdoor: "from-emerald-200/70 via-teal-100 to-sky-200/70",
  Professional: "from-indigo-200/70 via-violet-100 to-purple-200/70",
}
                    ...
                    <Tooltip key={set.name}>
                      <TooltipTrigger asChild>
                        ...
                        >
                          ...
                          >
                            <span className="text-center leading-tight">{set.label}</span>
                            {isSelected && (
